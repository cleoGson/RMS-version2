...
<a href="{{ route($routeKey.'.password_reset',encrypt($row->id)) }}" class="dropdown-item bg-dark text-white"  onclick="return confirm('Your are about to reset password, the action cannot be revesed')"> <i class="fa fa-edit"></i>Reset Password</a> 
