...
<i class="fa fa-align-justify"></i>List of Attachment Type 

  
  <a href="{{ route('general.attachmenttype.create') }}" class="float-right">
...
<table width="100%" class="table table-responsive-sm table-bordered table-striped table-hover" id="attachmenttype">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/general/attachmenttype';
            var start = '';
            var end = '';
            var orign = '/general/attachmenttype';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#attachmenttype').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#attachmenttype tbody').on('click', 'td.details-control', function () {
