            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class=" m-0 text-dark">
                        <p class="blue">
                        Edit Attachment Type  <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </p>
                    </h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('general.attachmenttype.index') }}" class="blue">Attachment Type List</a>
                        </li>
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-body card card-accent-primary">
                    {!! Form::model($show,['method'=>'PATCH','route'=>['general.attachmenttype.update',$show->id],'files'=>true]); !!}
