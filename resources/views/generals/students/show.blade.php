...
<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#messages-1" role="tab" aria-controls="messages" aria-selected="false"><i class="fa fa-users" style="color:blue"></i>Relative</a></li>
</ul>
