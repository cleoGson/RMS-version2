...
?>
  ...
  <td> 
  @if($std_number > 0 ) 
  <a  class="list_of_students" href="{{url('examination/class_student',['class_id'=>$class_id,'year_id'=>$year_id])}}" >
  ...
  <td> @if($std_number > 0 ) 
  <a class="list_of_students" href="{{url('examination/class_student',['class_id'=>$class_id,'year_id'=>$year_id])}}" >{{$std_number}}</a>
        @else
     {{$std_number}}   
        @endif
</td> 
