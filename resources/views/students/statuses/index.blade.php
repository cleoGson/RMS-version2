...
<i class="fa fa-align-justify"></i>List of studentstatuss 

  
  <a href="{{ route('student.studentstatus.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="studentstatus">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/student/studentstatus';
            var start = '';
            var end = '';
            var orign = '/student/studentstatus';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#studentstatus').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#studentstatus tbody').on('click', 'td.details-control', function () {
