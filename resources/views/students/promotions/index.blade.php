...
<i class="fa fa-align-justify"></i>List of  Students 
  ...
  <a href="{{ route('student.promotion.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="promotion">
<thead>
<tr>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/student/promotion';
            var start = '';
            var end = '';
            var orign = '/student/promotion';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#promotion tbody').on('click', 'td.details-control', function () {
