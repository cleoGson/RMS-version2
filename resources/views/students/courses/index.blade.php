...
<i class="fa fa-align-justify"></i>List of courses 

  
  <a href="{{ route('student.course.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="course">
<thead>
<tr>
...
@section('scripts')
    ...
    '</table>';
        ...
        $('#course tbody').on('click', 'td.details-control', function () {
