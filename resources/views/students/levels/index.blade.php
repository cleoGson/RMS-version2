...
<i class="fa fa-align-justify"></i>List of levels 

  
  <a href="{{ route('student.level.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="level">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/student/level';
            var start = '';
            var end = '';
            var orign = '/student/level';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#level tbody').on('click', 'td.details-control', function () {
