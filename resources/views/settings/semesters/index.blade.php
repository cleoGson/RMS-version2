...
<i class="fa fa-align-justify"></i>List of Salary Scales
  ...
  <a href="{{ route('setting.semester.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="semester">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/semester';
            var start = '';
            var end = '';
            var orign = '/setting/semester';
            function format ( d ) {
