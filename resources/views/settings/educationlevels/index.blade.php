...
<i class="fa fa-align-justify"></i>List of Education levels 

  
  <a href="{{ route('setting.educationlevel.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="educationlevel">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/educationlevel';
            var start = '';
            var end = '';
            var orign = '/setting/educationlevel';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#educationlevel').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#educationlevel tbody').on('click', 'td.details-control', function () {
