...
<i class="fa fa-align-justify"></i>List of Terms of Services 

  
  <a href="{{ route('setting.termsofservice.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="termsofservice">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/termsofservice';
            var start = '';
            var end = '';
            var orign = '/setting/termsofservice';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#termsofservice').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#termsofservice tbody').on('click', 'td.details-control', function () {
