...
<i class="fa fa-align-justify"></i>List of Relationships 

  
  <a href="{{ route('setting.familyrelationship.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="familyrelationship">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/familyrelationship';
            var start = '';
            var end = '';
            var orign = '/setting/familyrelationship';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#familyrelationship').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#familyrelationship tbody').on('click', 'td.details-control', function () {
