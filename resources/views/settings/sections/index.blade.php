...
<i class="fa fa-align-justify"></i>List of Sections 

  
  <a href="{{ route('setting.section.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="section">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/section';
            var start = '';
            var end = '';
            var orign = '/setting/section';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#section tbody').on('click', 'td.details-control', function () {
