...
<section class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class=" m-0 text-dark">
                        <p class="blue">
                        Create Section  <i class="fas fa-plus-circle fa-fw"></i>
                        </p>
                    </h1>
                </div>
                ...
                <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('setting.section.index') }}" class="blue">Section List</a>
                        </li>
    ...
    <section class="content">
        ...
        {!! Form::open(['route'=>'setting.section.store','files'=>true]); !!}
         ...
         <div class="col-md-12 form-group text-right">
                    <div class="pull-right">
                        ...
                        <a href="{{route('setting.section.index')}}" class="btn btn-primary">
