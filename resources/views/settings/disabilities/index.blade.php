...
<i class="fa fa-align-justify"></i>List of disabilities 

  
  <a href="{{ route('setting.disability.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="disability">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/disability';
            var start = '';
            var end = '';
            var orign = '/setting/disability';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#disability').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#disability tbody').on('click', 'td.details-control', function () {
