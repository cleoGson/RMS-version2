...
<i class="fa fa-align-justify"></i>List of Marital Statuses 

  
  <a href="{{ route('setting.marital.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="marital">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/marital';
            var start = '';
            var end = '';
            var orign = '/setting/marital';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#marital tbody').on('click', 'td.details-control', function () {
