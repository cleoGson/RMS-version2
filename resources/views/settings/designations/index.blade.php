...
<i class="fa fa-align-justify"></i>List of Designations 

  
  <a href="{{ route('setting.designation.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="designation">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/setting/designation';
            var start = '';
            var end = '';
            var orign = '/setting/designation';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#designation tbody').on('click', 'td.details-control', function () {
