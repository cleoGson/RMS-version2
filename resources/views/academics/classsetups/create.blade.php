...
<section class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class=" m-0 text-dark">
                        <p class="blue">
                        Create class Setup <i class="fas fa-plus-circle fa-fw"></i>
                        </p>
                    </h1>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right" style="color:white; font-size:14px; font-weight:bold; background-color:#50f56712">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('academic.classsetup.index') }}" class="blue">classsetup List</a>
                        </li>
    ...
    <section class="content">
        ...
        {!! Form::open(['route'=>'academic.classsetup.store','files'=>true]); !!}
