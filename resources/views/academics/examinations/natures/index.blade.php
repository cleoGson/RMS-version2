...
<i class="fa fa-align-justify"></i>List Of Examination nature

  
  <a href="{{ route('academic.examinationnature.create') }}" class="float-right">
...
<table class="table  table-bordered table-striped table-responsive-sm  table-striped table-hover" id="examinationnature">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/examinationnature';
            var start = '';
            var end = '';
            var orign = '/academic/examinationnature';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#examinationnature').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#examinationnature tbody').on('click', 'td.details-control', function () {
