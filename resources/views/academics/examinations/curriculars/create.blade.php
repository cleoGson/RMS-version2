            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class=" m-0 text-dark">
                        <p class="blue">
                        Create Examination Curricular  <i class="fas fa-plus-circle fa-fw"></i>
                        </p>
                    </h1>
                </div>
        ...
        {!! Form::open(['route'=>'academic.examinationcurricular.store','files'=>true]); !!}
         ...
         <div class="col-md-12 form-group text-right">
                    <div class="pull-right">
                        ...
                        <a href="{{route('academic.examinationcurricular.index')}}" class="btn btn-primary">
