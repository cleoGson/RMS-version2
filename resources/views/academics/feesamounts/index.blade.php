...
<i class="fa fa-align-justify"></i>List of feesamounts 

  
  <a href="{{ route('academic.feesamount.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="feesamount">
<thead>
<tr>
<th>Fees</th>
<th>Amount</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/feesamount';
            var start = '';
            var end = '';
            var orign = '/academic/feesamount';
            function format ( d ) {
    ...
    return '<table cellpadding="5" class="table table-responsive-sm table-bordered table-striped" cellspacing="0" border="0" style="padding-left:50px;">'+
      '<tr>'+
            '<td>Fees name:</td>'+
            '<td colspan="3">'+d.fees_id+'</td>'+
        '</tr>'+
        '<tr>'+
            '<td>fees amount :</td>'+
            '<td colspan="3">'+d.amount+'</td>'+
        '</tr>'+
    ...
    '</table>';
            ...
            var table = $('#feesamount').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#feesamount tbody').on('click', 'td.details-control', function () {
