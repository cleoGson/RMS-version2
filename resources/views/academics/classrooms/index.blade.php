...
<i class="fa fa-align-justify"></i>List of classrooms 

  
  <a href="{{ route('academic.classroom.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="classroom">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/classroom';
            var start = '';
            var end = '';
            var orign = '/academic/classroom';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#classroom tbody').on('click', 'td.details-control', function () {
