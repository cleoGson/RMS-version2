...
<i class="fa fa-align-justify"></i>List of events 
  ...
  <a href="{{ route('academic.event.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="event">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/event';
            var start = '';
            var end = '';
            var orign = '/academic/event';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#event tbody').on('click', 'td.details-control', function () {
