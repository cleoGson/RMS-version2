...
<i class="fa fa-align-justify"></i>List of fees 

  
  <a href="{{ route('academic.fees.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="fees">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/fees';
            var start = '';
            var end = '';
            var orign = '/academic/fees';
            function format ( d ) {
    ...
    '</table>';
        ...
        $('#fees tbody').on('click', 'td.details-control', function () {
