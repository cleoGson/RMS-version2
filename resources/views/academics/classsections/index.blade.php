...
<i class="fa fa-align-justify"></i>List of class sections 

  
  <a href="{{ route('academic.classsection.create') }}" class="float-right">
...
<table class="table table-responsive-sm table-bordered table-striped table-hover" id="classsection">
<thead>
<tr>
<th>Name</th>
<th>Display Name</th>
...
@section('scripts')
    <script>
        $(function () {
            var url = '/academic/classsection';
            var start = '';
            var end = '';
            var orign = '/academic/classsection';
            function format ( d ) {
    ...
    '</table>';
            ...
            var table = $('#classsection').DataTable({
                serverSide: true,
                processing: true,
        ...
        $('#classsection tbody').on('click', 'td.details-control', function () {
