...
use App\Model\Parentslinformation;
use Illuminate\Http\Request;
use Yajra\DataTables\DataTables;
use App\Http\Requests\Student\StudentstatusRequest;

class ParentslinformationController extends Controller
{
    /**
     ...
     *
     * @param  \App\Model\Parentslinformation  $parentslinformation
     * @return \Illuminate\Http\Response
     */
    public function show(Parentslinformation $parentslinformation)
    { 
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Parentslinformation $parentslinformation)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Parentslinformation $parentslinformation)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Parentslinformation $parentslinformation)
    {
